...
class FavaCurrencyTracker(FavaExtensionBase):
    ...
    def api_availability(self) -> dict[str, object]:
        ...
        # Exclude prices generated by plugins (e.g. generate_inverse_prices, generate_base_ccy_prices)
        prices = [p for p in prices if not (p.meta and p.meta.get("generated_by"))]
